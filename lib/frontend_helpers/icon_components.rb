...
module IconComponents
  ...
  MONEY_BILL_WAVE = %(
    <svg viewBox="0 0 640 512" class="svg-inline--fa fa-money-bill-wave">
      <path fill="currentColor"
  ...
  FACEBOOK_SQUARE = %(
    <svg viewBox="0 0 448 512" class="svg-inline--fa fa-facebook-square">
      <path fill="currentColor"
  ...
  INSTAGRAM_SQUARE = %(
    <svg viewBox="0 0 448 512" class="svg-inline--fa fa-instagram-square">
      <path fill="currentColor"
  ...
  STAR = %(
    <svg viewBox="0 0 576 512" class="svg-inline--fa fa-star solid-star">
      <path fill="currentColor"
  ...
  FIRE_ALT = %(
    <svg viewBox="0 0 448 512" class="svg-inline--fa fa-fire-alt">
      <g class="fa-group">
        <path fill="currentColor"
  ...
  CHEVRON_DOBLE_DOWN = %(
    <svg viewBox="0 0 448 512" class="svg-inline--fa fa-chevron-double-down">
      <path fill="currentColor"
  ...
  CHEVRON_DOBLE_UP = %(
    <svg viewBox="0 0 448 512" class="svg-inline--fa fa-chevron-double-up">
      <path fill="currentColor"
  ...
  PAYPAL = %(
    <svg viewBox="0 0 384 512" class="svg-inline--fa fa-paypal">
      <path fill="currentColor"
  ...
  GIFT = %(
    <svg viewBox="0 0 512 512" class="svg-inline--fa fa-gift">
      <path fill="currentColor"
  ...
  MAP_MARKED_ALT = %(
    <svg viewBox="0 0 576 512" class="svg-inline--fa fa-map-marked-alt">
      <path fill="currentColor"
  ...
  PHONE_PLUS = %(
    <svg viewBox="0 0 512 512" class="svg-inline--fa fa-phone-plus">
      <path fill="currentColor"
  ...
  RECEIPT = %(
    <svg viewBox="0 0 448 512" class="svg-inline--fa fa-receipt">
      <path fill="currentColor"
  ...
  PEN = %(
    <svg viewBox="0 0 512 512" class="svg-inline--fa fa-pen">
      <path fill="currentColor"
  ...
  IMAGE = %(
    <svg viewBox="0 0 512 512" class="svg-inline--fa fa-image">
      <path fill="currentColor"
  ...
  ELLIPSIS_H = %(
    <svg viewBox="0 0 512 512" class="svg-inline--fa fa-ellipsis-h">
      <path fill="currentColor"
  ...
  UPLOAD = %(
    <svg viewBox="0 0 512 512" class="svg-inline--fa fa-upload">
      <path fill="currentColor"
  ...
  CLOUD_UPLOAD_ALT = %(
    <svg viewBox="0 0 640 512" class="svg-inline--fa fa-cloud-upload-alt">
      <path fill="currentColor"
